...
static void itlb_miss(irq_t source, irq_context_t *context, void *) {
    mmu_gen_tlb_miss("itlb_miss", source, context);
}

/* Instruction TLB protection violation */
static void itlb_pv(irq_t source, irq_context_t *context, void *) {
...
/* Data TLB miss (read) */
static void dtlb_miss_read(irq_t source, irq_context_t *context, void *) {
    mmu_gen_tlb_miss("dtlb_miss_read", source, context);
}

/* Data TLB miss (write) */
static void dtlb_miss_write(irq_t source, irq_context_t *context, void *) {
    mmu_gen_tlb_miss("dtlb_miss_write", source, context);
}

/* Data TLB protection violation (read) */
static void dtlb_pv_read(irq_t source, irq_context_t *context, void *) {
    dbgio_printf("dtlb_pv_read\n");
    unhandled_mmu(source, context);
}

/* Data TLB protection violation (write) */
static void dtlb_pv_write(irq_t source, irq_context_t *context, void *) {
    dbgio_printf("dtlb_pv_write\n");
    unhandled_mmu(source, context);
}

/* Initial page write exception */
static void initial_page_write(irq_t source, irq_context_t *context, void *) {
